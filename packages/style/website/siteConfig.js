...
const siteConfig = {
  ...
  scripts: ['https://buttons.github.io/buttons.js', '/agent-interface/style/js/code-collapsed-toggle.js', 'http://code.jquery.com/jquery.js', '/agent-interface/style/js/demoscript.js'],
