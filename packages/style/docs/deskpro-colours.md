...
<div class="dp-Bg-ColorDemonstration">
    ...
    <div class="Bg-Color--grey-darkest"></div>
    <div class="Bg-Color--grey-dark"></div>
    <div class="Bg-Color--grey"></div>
    <div class="Bg-Color--grey-light"></div>
    <div class="Bg-Color--grey-lighter"></div>
    <div class="Bg-Color--grey-lightest"></div>
    ...
    <div class="Bg-Color--purple-light"></div>
