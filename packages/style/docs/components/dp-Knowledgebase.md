                ...
                <li class="dp-ListPane dp-DropDownItem is-active">
                    ...
                    <ul class="dp-Menu Menu-tick is-active">
                        ...
                        <li class="dp-Menu-linkItem dp-SortOrder">
                            ...
                            <!-- checkbox -->
                            <span class="dp-CustomCheckbox">
                                <input type="checkbox" class="dp-ControlInput" id="comment-00"></input>
                                <label for="comment-00">Enable drag and drop</br> re-ordering</label>
                            </span>
        ...
        <ul class="dp-Menu Menu-tick is-active" style="top:0">
            ...
            <li class="dp-Menu-linkItem dp-SortOrder">
                ...
                <span class="dp-CustomCheckbox">
                    ...
                    <label for="comment-0">Enable drag and drop</br> re-ordering</label>
                </span>
