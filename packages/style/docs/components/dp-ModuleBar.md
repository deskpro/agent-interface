---
title: Modulebar/general
---
<h2>modulebar/container</h2>

```html @preview
<div class="dp-ModulebarContainer"></div>
```

<h2>modulebar-static/rollover</h2>
```html @preview
<div class="dp-ModulebarContainer Modulebar--rollover">
    <ul class="dp-ModuleBar">
      ...
      <li class="dp-ModuleBarList is-borderBottom">
        <a class="dp-Icon dp-billing_money" href="#"></a>
        <span class="dp-IconTooltip">Billing</span>
      </li>

      <li class="dp-ModuleBarList dp-integration">
...
<div class="dp-ModulebarContainer Modulebar--selected">
    <ul class="dp-ModuleBar">
      ...
      <li class="dp-ModuleBarList is-borderBottom is-active">
        <a class="dp-Icon dp-billing_money" href="#"></a>
      </li>
...
<div class="dp-ModulebarContainer Modulebar--rollover">
    <ul class="dp-ModuleBar">
      ...
      <li class="dp-ModuleBarList">
        <a class="dp-Icon dp-assets" href="#"></a>
        <span class="dp-IconTooltip">Assets</span>
      </li>

      <li class="dp-ModuleBarList">
        <a class="dp-Icon dp-forms" href="#"></a>
        <span class="dp-IconTooltip">Forms</span>
      </li>

      <li class="dp-ModuleBarList">
        <a class="dp-Icon dp-deal" href="#"></a>
        <span class="dp-IconTooltip">Deals</span>
      </li>
