---
title: TicketProperties
---

```html @preview
<div style="height: 500px; position: relative;">
    <div class="dp-TicketProperties dp-MenuBarIcon is-active">
        <ul class="dp-MenuBarList">
            <li class="dp-MenuBarItem dp-PropertiesItem dp-DropMenuJs">
        ...
        <div class="dp-BarListWrapper">
            <div class="dp-PropertyList">
                ...
                <ul class="dp-PropertySubTitleList">
                    ...
                    <li class="dp-SubTitleListItem"><i class="dp-Icon dp-icon-cloud"></i>Deskpro Cloud</li>
                    <li class="dp-SubTitleListItem"><i class="dp-Icon dp-UKIcon"></i>English (UK)</li>
                    <li class="dp-SubTitleListItem"><i class="dp-Icon dp-mute"></i>Voice</li>
