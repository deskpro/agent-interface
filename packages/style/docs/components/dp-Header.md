    ...
    <div class="dp-HeaderContainer">
        <div class="dp-TopActionRow">
            ...
            <div class="dp-SearchBox">
                ...
                <span class="dp-Recent"><span class="dp-Icon dp-history"></span></span>
...
```html @preview
<!-- <div class="dp-Header Header-general">
    <div class="dp-HeaderContainer">
...
<div class="dp-Header header-wrapper demo-menu" style="height:340px;align-items:flex-start;padding: 15px;">
    <div class="dp-HeaderContainer">
        <div class="dp-TopActionRow">
